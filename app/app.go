...
func New(
	...
	*/
	...
	app.mm.SetOrderInitGenesis(
		...
		icatypes.ModuleName, intertxtypes.ModuleName, authz.ModuleName, feegrant.ModuleName, paramstypes.ModuleName, upgradetypes.ModuleName, vestingtypes.ModuleName,
